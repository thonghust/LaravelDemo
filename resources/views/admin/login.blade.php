	...
	<div class="container text-center">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3><span class="glyphicon glyphicon-log-in"></span> Đăng nhập</h3>
			</div>
			<form method="post">
				@csrf
				<div class="panel-body">
					<div class="error">
						...
						<div class="alert alert-success">
							<strong><big>Đăng ký thành công !!</big></strong>
							<ul>
								<li>{{ session('thongbao1') }}</li>
							</ul>
						</div>
						@endif
					</div>
					...
					<div class="form-group">
						<input type="password" name="mk" class="form-control" placeholder="Password">
					</div>
					<div class="form-group">
						<button class="btn btn-lg btn-success">Đăng nhập</button>
					</div>
					<div class="form-group">
						<a href="{{ route('getRegister') }}" class="btn btn-lg btn-info">Đăng ký</a>
