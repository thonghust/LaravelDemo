...
<div class="create">
	...
	<form method="post">
		...
		<div class="form-group">
			...
			<input type="text" name="hoten" placeholder="Điền họ tên vào đây..." value="{{ $bien->name }}" class="form-control">
		</div>
		<div class="form-group">
			<p><strong>Email:</strong></p>
			<input type="text" name="email" placeholder="Điền mô tả vào đây..." value="{{ $bien->email }}" readonly="" class="form-control">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<label class="radio-inline"><input value="0" type="radio" name="quyen" @if($bien->quyen == 0) {{ "checked" }} @endif> Thường</label>
			<label class="radio-inline"><input value="1" type="radio" name="quyen" @if($bien->quyen == 1 ) {{ "checked" }} @endif> Admin</label>
		</div><br>
		<div class="form-group">
			<button class="btn btn-default">Sửa User</button>
